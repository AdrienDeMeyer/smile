$(document).ready(function() {
  ...
  var circleClone = circle.clone().attr({
    cx: 250
  });
  var ellipse = s.ellipse(100, 100, 10, 15).attr({
    fill: "black"
  });
  var ellipseClone = ellipse.clone().attr({
    cx: 250
  });
  ...
  function OnMouseMove(evt) {
    ...
    L1.attr({
      d: "M 100 100 L " + evt.clientX + " " + evt.clientY
    });
    L2.attr({
      d: "M 250 100 L " + evt.clientX + " " + evt.clientY
    });
    ...
    if (distance < radiusZone) {
      mouth.attr({
        d: "M 125 250 q 50 " + smile1 + " 100 20"
      });
    } else {
      mouth.attr({
        d: "M 125 250 q 50 0 100 20"
      });
    }
